...
export default function Properties() {
  ...
  const selectedCamera = useDesignerStore((state) =>
    state.cameras.find(
      (cameraItem) => cameraItem.selected,
    ),
  );
  ...
  const selectionTitle = selectedCamera
    ? selectedCamera.name
    : selectedWall
      ? "Wall"
      : "No object selected";
    ...
    <>
      ...
      >
        ...
        >
            ...
            {!selectedWall &&
              !selectedCamera && (
                <div style={placeholderStyle}>
                  Select a wall or camera on the
                  canvas to inspect and edit it.
                </div>
              )}
          ...
          >
            <div style={placeholderStyle}>
              Recording days, frame rate,
              compression and disk recommendations
              will appear here.
            </div>
          </InspectorSection>
          ...
          >
            <div style={placeholderStyle}>
              Equipment cost, labour, markup,
              selling price and margin will appear
              here.
            </div>
          </InspectorSection>
          ...
          >
            <div style={placeholderStyle}>
              Automated coverage reviews, equipment
